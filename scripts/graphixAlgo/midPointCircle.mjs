...
function midPointCircle(circle, wantStep = false) {
...
export default function fullMidPointCircle(circle, wantStep = false) {
    let basePoints, step;
    if (wantStep)
        [basePoints, step] = midPointCircle(circle, wantStep);
    else basePoints = midPointCircle(circle, wantStep)
